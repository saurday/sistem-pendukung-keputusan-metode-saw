...
<?php include 'menu.php';?>
    <div class="content-wrapper">
        <div class="container">
            <div class="row">
                <div class="col-md-12">
                    <h4 class="page-head-line">Penilaian Perguruan Tinggi Swasta</h4>
                </div>
            </div>
            <div class="row">
                <div class="col-md-12">
            ...
            <div class="row">
                ...
                <div class="table-responsive">
                    <table id="example1" class="table table-striped table-bordered">
                        ...
                        <tbody>
                            <?php $no=1; foreach($db->select('pts.id_calon_kr,pts.nama_pts,hasil_tpa.*','pts,hasil_tpa')->where('pts.id_calon_kr=hasil_tpa.id_calon_kr')->get() as $data): ?>
                            <tr>
                                <td><?= $no;?></td>
                                <td><?= $data['nama_pts']?></td>
