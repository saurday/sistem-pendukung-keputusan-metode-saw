              ...
              <div class="panel panel-default">
                  ...
                  <div class="panel-body">
                      <form method="post" action="update_tpa.php">
                          ...
                          <?php endif ?>
                          <?php foreach ($db->select('hasil_tpa.*,pts.id_calon_kr,pts.nama_pts','hasil_tpa,pts')->where('hasil_tpa.id_calon_kr=pts.id_calon_kr and hasil_tpa.id_calon_kr='.$_GET['id'])->get() as $data): ?>
                          	  <input type="hidden" name="id" value="<?= $data['id_calon_kr']?>">
                                <div class="form-group col-md-12">
                                  <label for="nama_pts">Nama Perguruan Tinggi Swasta</label>
                                  <input type="text" class="form-control" id="nama_pts" name="nama_pts" value="<?= $data['nama_pts']?>" readonly>
                              </div>
